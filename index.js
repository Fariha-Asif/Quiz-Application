...
console.log(chalk.greenBright("Dear"), chalk.bold.yellowBright(`${intro.name}`), chalk.greenBright("You should get 4 points atleast for win in the quiz."));
let condition = true;
while (condition) {
    ...
    if (options.options === "HTML") {
        ...
        let html2 = await inquirer.prompt({
            name: "two",
            type: "list",
            message: chalk.redBright("2) The correct sequence of HTML tags for starting a webpage is:"),
            choices: [
        ...
        let html3 = await inquirer.prompt({
            name: "three",
            type: "list",
            message: chalk.redBright("3) Which of the following element is responsible for making the text bold in HTML?"),
        ...
        let html4 = await inquirer.prompt({
            name: "four",
            type: "list",
            message: chalk.redBright("4) Which of the following tag is used for inserting the largest heading in HTML?"),
        ...
        let html5 = await inquirer.prompt({
            name: "five",
            type: "list",
            message: chalk.redBright("5) Which of the following tag is used to insert a line-break in HTML?"),
        ...
        let css2 = await inquirer.prompt({
            name: "two",
            type: "list",
            message: chalk.redBright("2) Which of the following is the correct syntax to add the external stylesheet in CSS:"),
            choices: [
        ...
        if (css2.two === `(d) <link rel="stylesheet" type="quiz/css" href="quiz.css">`) {
            console.log(chalk.magentaBright("Your answer is correct"));
            points1++;
        }
        else {
        ...
        let css3 = await inquirer.prompt({
            name: "three",
            type: "list",
            message: chalk.redBright("3)Which of the below CSS properties is used to change the background color of CSS ?"),
            choices: [
                "(a) bg color",
                "(b) color-background",
                "(c) background-color",
        ...
        let css4 = await inquirer.prompt({
            name: "four",
            type: "list",
            message: chalk.redBright("4) Which of the below CSS class is used to change the text color of CSS ?"),
            choices: [
                "(a) background-color",
                "(b) color",
                "(c) color-background",
        ...
        let css5 = await inquirer.prompt({
            name: "five",
            type: "list",
            message: chalk.redBright("5) Which of the below is the correct syntax to put a line over text in CSS?"),
            choices: [
    ...
    // 3rd option
        ...
        if (java2.two === "d) Java is a platform-independent programming language") {
            console.log(chalk.magentaBright("Your answer is correct"));
            points2++;
        }
        else {
        ...
        let java3 = await inquirer.prompt({
            name: "three",
            type: "list",
            message: chalk.redBright("Which component is used to compile, debug and execute the java programs?"),
    ...
    // 4th option
        ...
        let ts4 = await inquirer.prompt({
            name: "four",
            type: "list",
            message: chalk.redBright("4. How do you specify that a function does not return anything in TypeScript?"),
            choices: [
    ...
    // 5th option
        ...
        let py4 = await inquirer.prompt({
            name: "four",
            type: "list",
            message: chalk.redBright("4. Which of the following is the correct extension of the Python file?"),
    ...
    // 6th option
        ...
        let c3 = await inquirer.prompt({
            name: "three",
            type: "list",
            message: chalk.redBright("3. Which of the following is the correct syntax of including a user defined header files in C++?"),
            choices: [
        ...
        let c5 = await inquirer.prompt({
            name: "five",
            type: "list",
            message: chalk.redBright("5. Which of the following user-defined header file extension used in c++?"),
